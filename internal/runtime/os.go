...
func OS(vm *goja.Runtime, module *goja.Object) {
	...
	// arch()
	_ = _os.Set("arch", func(call goja.FunctionCall) goja.Value {
		return vm.ToValue(runtime.GOARCH)
	})

	// platform()
	_ = _os.Set("platform", func(call goja.FunctionCall) goja.Value {
		return vm.ToValue(runtime.GOOS)
	})

	// release() — kernel version
	_ = _os.Set("release", func(call goja.FunctionCall) goja.Value {
	...
	// type()
	_ = _os.Set("type", func(call goja.FunctionCall) goja.Value {
		return vm.ToValue("Linux") // Or adjust based on runtime.GOOS
	})

	// homedir()
	_ = _os.Set("homedir", func(call goja.FunctionCall) goja.Value {
		home, _ := os.UserHomeDir()
		return vm.ToValue(home)
	})

	// hostname()
	_ = _os.Set("hostname", func(call goja.FunctionCall) goja.Value {
	...
	// tmpdir()
	_ = _os.Set("tmpdir", func(call goja.FunctionCall) goja.Value {
		return vm.ToValue(os.TempDir())
	})

	// uptime()
	_ = _os.Set("uptime", func(call goja.FunctionCall) goja.Value {
	...
	_ = _os.Set("freemem", func(call goja.FunctionCall) goja.Value {
	...
	_ = _os.Set("totalmem", func(call goja.FunctionCall) goja.Value {
		var mem syscall.Sysinfo_t
		if err := syscall.Sysinfo(&mem); err != nil {
	...
	// loadavg()
	_ = _os.Set("loadavg", func(call goja.FunctionCall) goja.Value {
	...
	// endianness()
	_ = _os.Set("endianness", func(call goja.FunctionCall) goja.Value {
	...
	_ = _os.Set("availableParallelism", func(call goja.FunctionCall) goja.Value {
		return vm.ToValue(runtime.NumCPU())
	})

	// machine()
	_ = _os.Set("machine", func(call goja.FunctionCall) goja.Value {
	...
	// userInfo()
	_ = _os.Set("userInfo", func(call goja.FunctionCall) goja.Value {
	...
	for _, name := range notImplList {
		_ = _os.Set(name, notImplemented(name))
	}
